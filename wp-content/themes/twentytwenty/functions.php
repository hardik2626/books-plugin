...
// Register Custom Post Type Corus Solution
/* function create_corussolution_cpt() {

	$labels = array(
		'name' => _x( 'Corus Solution', 'Post Type General Name', 'textdomain' ),
		'singular_name' => _x( 'Corus Solution', 'Post Type Singular Name', 'textdomain' ),
		'menu_name' => _x( 'Corus Solution', 'Admin Menu text', 'textdomain' ),
		'name_admin_bar' => _x( 'Corus Solution', 'Add New on Toolbar', 'textdomain' ),
		'archives' => __( 'Corus Solution Archives', 'textdomain' ),
		'attributes' => __( 'Corus Solution Attributes', 'textdomain' ),
		'parent_item_colon' => __( 'Parent Corus Solution:', 'textdomain' ),
		'all_items' => __( 'All Corus Solution', 'textdomain' ),
		'add_new_item' => __( 'Add New Corus Solution', 'textdomain' ),
		'add_new' => __( 'Add New', 'textdomain' ),
		'new_item' => __( 'New Corus Solution', 'textdomain' ),
		'edit_item' => __( 'Edit Corus Solution', 'textdomain' ),
		'update_item' => __( 'Update Corus Solution', 'textdomain' ),
		'view_item' => __( 'View Corus Solution', 'textdomain' ),
		'view_items' => __( 'View Corus Solution', 'textdomain' ),
		'search_items' => __( 'Search Corus Solution', 'textdomain' ),
		...
		'insert_into_item' => __( 'Insert into Corus Solution', 'textdomain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Corus Solution', 'textdomain' ),
		'items_list' => __( 'Corus Solution list', 'textdomain' ),
		'items_list_navigation' => __( 'Corus Solution list navigation', 'textdomain' ),
		'filter_items_list' => __( 'Filter Corus Solution list', 'textdomain' ),
	);
	$args = array(
		'label' => __( 'Corus Solution', 'textdomain' ),
	...
	register_post_type( 'corussolution', $args );

}
add_action( 'init', 'create_corussolution_cpt', 0 ); */
...
/* function books_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Book Search', 'text_domain' ),
		'labels'                => $labels,
